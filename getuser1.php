...
$result = mysqli_query($con,"SELECT * FROM price order by long_price DESC limit 10");
$result1 = mysqli_query($con,"SELECT COUNT(long_price)  AS long_price FROM price");
$result2 = mysqli_query($con,"SELECT SUM(long_price) FROM price");
...
$row2 = mysqli_fetch_array($result2);
        ...
        echo "<th width=\"25%\"><b>首季保费累计</b></th>";
    ...
    if($x<=3){
        echo
            "<tr class=\"text-ye lead\">
                ...
                <td><h3><b>". round($row['long_price'],1) ."万元</b></h3></td>
                </tr>";
    }
    else{
        echo
            "<tr class=\"lead\">
                ...
                <td><b>". $row['name'] ."</b></td>
                <td><b>". round($row['long_price'],1) ."万元</b></td>
                </tr>";
    }
